...
class CategoriesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        foreach ($major_category_names as $major_category_name) {
            // find the MajorCategory record created by MajorCategoriesSeeder
            $major = MajorCategory::where('name', $major_category_name)->first();
            $majorId = $major ? $major->id : 0;
